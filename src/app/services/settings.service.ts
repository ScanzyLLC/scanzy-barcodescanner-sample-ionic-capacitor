          ...
          if (value == null) {
            value = ({
              ...
              barcode: {
                ...
                '2D': [{type: ScanzyBarcodeFormat.QRCode, value: true},{type: ScanzyBarcodeFormat.DataMatrix, value: true},{type: ScanzyBarcodeFormat.PDF417, value: true},{type: ScanzyBarcodeFormat.Aztec, value: true}, {type: ScanzyBarcodeFormat.MaxiCode, value: false}]
              }
            }) as ISettings;
